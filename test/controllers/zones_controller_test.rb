...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { city_id: @zone.city_id, description: @zone.description, name: @zone.name } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { city_id: @zone.city_id, description: @zone.description, name: @zone.name } }
