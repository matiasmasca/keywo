...
class CollaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post collaborators_url, params: { collaborator: { city_id: @collaborator.city_id, disponibilidad: @collaborator.disponibilidad, herramientas: @collaborator.herramientas, mobilidad: @collaborator.mobilidad, others_skills: @collaborator.others_skills, skill_id: @collaborator.skill_id, zone_id: @collaborator.zone_id } }
    end
  ...
  test "should update collaborator" do
    patch collaborator_url(@collaborator), params: { collaborator: { city_id: @collaborator.city_id, disponibilidad: @collaborator.disponibilidad, herramientas: @collaborator.herramientas, mobilidad: @collaborator.mobilidad, others_skills: @collaborator.others_skills, skill_id: @collaborator.skill_id, zone_id: @collaborator.zone_id } }
