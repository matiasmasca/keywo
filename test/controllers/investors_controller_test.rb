...
class InvestorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post investors_url, params: { investor: { monto_maximo: @investor.monto_maximo, monto_minimo: @investor.monto_minimo, sector_id: @investor.sector_id } }
    end
  ...
  test "should update investor" do
    patch investor_url(@investor), params: { investor: { monto_maximo: @investor.monto_maximo, monto_minimo: @investor.monto_minimo, sector_id: @investor.sector_id } }
